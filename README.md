...
This repo contains a sample project for Java/Groovy with Gradle and below you can
...
Any **Gradle** project may be used as a programming task. You can use any
testing framework supported by Gradle, this sample project uses Spock for
running unit tests.

Gradle build will be executed with the following command:
